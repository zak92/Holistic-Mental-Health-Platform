...
class DiscussionByCategoryTest(APITestCase):
  ...
  def setUp(self):
    ...
    self.good_url = reverse('api-discussions-by-category', kwargs={'category': 'mental-health'})
    self.bad_url = '/discussion/Mental-Health/'
