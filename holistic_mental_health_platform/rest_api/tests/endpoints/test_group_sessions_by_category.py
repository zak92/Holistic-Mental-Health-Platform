...
class GroupSessionsByCategoryTest(APITestCase):
  ...
  def setUp(self):
    ...
    self.good_url = reverse('api-group-sessions-by-category', kwargs={'category': 'nutrition'})
    self.bad_url = '/group-sessions/nutrition'
